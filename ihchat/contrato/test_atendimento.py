...
leem o provedor falso (IHCHAT_TESTE_PROVEDOR).
"""
...
def provedor_do_alvo(provedor):
    """O provedor falso (os dois alvos leem IHCHAT_TESTE_PROVEDOR)."""
    return provedor
...
def test_rajada_de_webhooks_nao_perde_mensagem_nem_nao_lidas(cliente, cabecalho_atendente, canal_whatsapp, servidor):
    ...
    só, e o contador de não lidas conta todas. Com IHCHAT_CONTRATO_MYSQL o
