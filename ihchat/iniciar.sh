#!/bin/sh
# Sobe o IHchat no Linux e no macOS: ./iniciar.sh
...
if command -v python3 >/dev/null 2>&1; then
    echo "O IHchat precisa do Python 3.10 ou mais novo. O python3 desta máquina: $(python3 --version 2>&1)" >&2
else
    echo "Não encontrei o Python 3 nesta máquina. O IHchat precisa do 3.10 ou mais novo." >&2
fi
