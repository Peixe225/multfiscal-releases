...
Sem argumentos, cria um administrador com a senha informada em IHCHAT_SENHA_ADMIN
...
container usa com IHCHAT_DEMO=0) a Ana nao nasce: a senha dela e publica, esta
...
def semear(demo: bool = False, producao: bool = False) -> None:
    ...
    with SessaoLocal() as sessao:
        ...
        senha = os.environ.get("IHCHAT_SENHA_ADMIN", "admin123")
        admin = Atendente(
            nome="Administrador",
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Popula a base do IHchat")
