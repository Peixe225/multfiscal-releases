...
final class Mime
{
     ...
     *
     * @param list<\IHchat\Atendimento\ArquivoParaEnviar> $arquivos
    ...
    public static function montar(
        ...
        $dominio = substr((string) strrchr($enderecoRemetente, '@'), 1) ?: 'ihchat.local';
        ...
        $fronteira = '=_ihchat_' . bin2hex(random_bytes(12));
