...
use IHchat\Canais\Email\ErroImap;
use IHchat\Canais\Email\ErroSmtp;
use IHchat\Canais\Email\Imap;
use IHchat\Canais\Email\Mime;
use IHchat\Canais\Email\Smtp;
...
final class AdaptadorEmail extends Adaptador
{
     ...
     * cadastro, em segredo_webhook), no cabeçalho X-IHchat-Token ou em ?token=
    ...
    public function verificarAssinatura(string $corpo, array $cabecalhos): bool
    {
        ...
        $enviado = $cabecalhos['x-ihchat-token'] ?? '';
     ...
     * @param array<string, \IHchat\Nucleo\ArquivoEnviado> $arquivos
