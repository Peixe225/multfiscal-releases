 ...
 * só com tabelas do IHchat (instalação anterior). Escolher por engano o
...
final class BaseInicial
{
    ...
    /**
     * Recusa (409) um banco com tabelas que não são do IHchat.
     *
     * Um banco é "nosso" se não tem tabela nenhuma ou se tem a tabela de
     * migrações do IHchat e nada fora da lista de tabelas que as nossas
    ...
    /**
     * Tabelas que as migrações do IHchat criam, lidas das próprias
