 ...
 * `IHchat\Canais\Registro::adaptadorPara(array $canal)`; enquanto ela
...
{
    public const REGISTRO = 'IHchat\\Canais\\Registro';
    ...
    public static function mensagemDeErro(\Throwable $erro): string
    {
        ...
        if (in_array($classe, ['ErroCanal', 'ErroTransporte', 'AnexoGrande', 'ErroDeCanal'], true)
            || $erro instanceof \IHchat\Nucleo\Http\ErroTransporte) {
