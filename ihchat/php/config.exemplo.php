 ...
 *
 * A variável de ambiente IHCHAT_CONFIG pode apontar outro arquivo (a suíte de
...
return [
    ...
    'driver' => 'mysql',
    'dsn' => 'mysql:host=localhost;dbname=u000000000_ihchat;charset=utf8mb4',
    'usuario' => 'u000000000_ihchat',
    'senha' => 'defina-uma-senha-forte',
    // Desenvolvimento: SQLite num arquivo.
    // 'driver' => 'sqlite',
    // 'dsn' => 'sqlite:' . __DIR__ . '/dados/ihchat.sqlite',
    ...
    // (IHCHAT_CHAVE_SECRETA): os atendentes continuam logados.
