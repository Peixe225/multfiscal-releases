@echo off
rem Sobe o OmniChannel 2 no Windows: de dois cliques neste arquivo.
...
:erro
echo.
echo O OmniChannel parou com erro. Leia as mensagens acima.
echo.
pause
popd
exit /b 1
...
:python_antigo
echo.
echo O OmniChannel 2 precisa do Python 3.10 ou mais novo. O desta maquina e:
%ANTIGO% --version
echo.
...
:sem_python
echo.
echo Nao encontrei o Python nesta maquina. O OmniChannel 2 precisa do Python 3.10 ou mais novo.
echo.
