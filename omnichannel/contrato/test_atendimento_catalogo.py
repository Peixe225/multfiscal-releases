...
@pytest.fixture
def campos_atendente(login_atendente) -> set[str]:
    """AtendenteSaida, com "setor" quando o alvo já o tem (pergunta ao alvo, não ao nome dele)."""
    return CAMPOS_ATENDENTE if "setor" in login_atendente["atendente"] else CAMPOS_ATENDENTE - {"setor"}
