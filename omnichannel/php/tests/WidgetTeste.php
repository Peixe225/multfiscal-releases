...
use OmniChannel\Widget\Limites;

/** Pasta de contadores descartável para cada teste. */
function pasta_limites(): string
{
    $pasta = sys_get_temp_dir() . '/omni-limites-' . bin2hex(random_bytes(4));
...
return [
    ...
    'faxina do widget roda pelo cron de hora em hora' => function (): void {
        Afirmar::igual(3600, \OmniChannel\Tarefas\FaxinaWidget::INTERVALO);
        Datas::congelar(new DateTimeImmutable('2026-01-01T00:00:00Z'));
        ...
        Afirmar::igual(
            ...
            \OmniChannel\Tarefas\FaxinaWidget::executar()
        );
        // nada a fazer: saída vazia, o cron não enche o log
        Afirmar::igual('', \OmniChannel\Tarefas\FaxinaWidget::executar());
    },
];
