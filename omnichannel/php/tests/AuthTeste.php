...
return [
    ...
    'config recusa chave padrao fora do sandbox' => function (): void {
        Afirmar::lanca(\OmniChannel\Nucleo\ErroConfiguracao::class, fn () => Config::deArray(['modo_sandbox' => false]));
        Afirmar::lanca(\OmniChannel\Nucleo\ErroConfiguracao::class, fn () => Config::deArray(['modo_sandbox' => false, 'chave_secreta' => 'curta']));
